    ...
    if advice_index_data and SEARCH_AVAILABLE and embedding_model:
        try:
            ...
            system_prompt = (
                ...
                "6. Tuyệt đối KHÔNG sử dụng bất kỳ định dạng Markdown nào trong câu trả lời (ví dụ: không viết đậm bằng **, không in nghiêng bằng *, không dùng các ký hiệu danh sách như -, *, 1., không dùng tiêu đề #, không dùng liên kết, v.v.). Chỉ sử dụng văn bản thuần túy (plain text) vì hệ thống sẽ không render Markdown.\n\n"
